                                    ...
                                    while($row=mysqli_fetch_assoc($exec_requete)){
                                        if(strtoupper($row["Marque"])==strtoupper("Audi")){
                                            if($row["Disponibilité"]=="Disponible"){
                                                ...
                                                <td><img src="'.$row["Photo_1"].'" width=100%;height:100%></td>
                                                ...
                                                <ul class="dropdown-menu dropdown_more">
                                                    <li>
                                                        <a href="./car.php?id='.$row["IdV"].'" target="_black">
                                                            <i class="fa fa-clone"></i>Afficher Plus
                                                        </a>
                                                    </li>
                                                ...
                                                echo '<tr><td style="display:flex; align-items:center;"><img width=100%;height:100%; src="./images/categ/audi.png"></td>
                                                <td>'.strtoupper($row["NomVoiture"]).'</td><td><img src="'.$row["Photo_1"].'" width=100%;height:100%></td><td>'.$row["CARROSSERIE"].'</td><td>'.$row["Prix"].'</td><td><span class="mode mode_off">'.$row["Disponibilité"].'</span></td>
                                                <td>
                                                <div class="btn-group">
                                                <a class="dropdown-toggle dropdown_icon" data-toggle="dropdown">
                                                    <i class="fa fa-ellipsis-h"></i>
