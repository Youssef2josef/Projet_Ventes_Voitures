...
if (!$connection) { // Contrôler la connexion
    ...
    $audis="SELECT * from voitures where Marque = 'Audi' order by Prix";
...
<head>
    ...
    <title>Audi</title>
    <link rel="shortcut icon" href="../images/categ/audi.png" type="image/x-icon">
    ...
    * {
    ...
    .feature {
        padding: 9%;
        background-image: url('../images/audi1.jpg');
...
<body>
    ...
    <section class="avant-home">
        <div class="container">
            <div class="slides">
                <div class="slide" style="background-image: url('../images/voitures/background_audi_1.webp');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
                    <div class="slide-content" style="color: bisque;">
                        <h1>This is Heading</h1>
                    </div>
                </div>
                <div class="slide" style="background-image: url('../images/voitures/background_audi_apres_changement.webp');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
                    <div class="slide-content" style="color: var(--black);">
                        <h1>audi a1</h1>
                    </div>
                </div>
                <div class="slide" style="background-image: url('../images/voitures/background_audi_2.webp');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
                    <div class="slide-content" style="color: var(--yellow);">
                        <h1>Audi A4</h1>
                    </div>
                </div>
                <div class="slide" style="background-image: url('../images/voitures/background_audi_3.webp');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
                    <div class="slide-content" style="color: rgba(250,50,50,.8) ; top:30%; font: size 4rem;">
                        <h1>Audi A7 <br>Sportback</h1>
                    </div>
                </div>
            </div>
