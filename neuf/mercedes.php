...
if (!$connection) { // Contrôler la connexion
    ...
    $mercedes="SELECT * from voitures where Marque = 'Mercedes' order by Prix";
...
<head>
    ...
    <link rel="shortcut icon" href="../images/categ/mercedes.png" type="image/x-icon">
    ...
    * {
    ...
    .feature {
        padding: 9%;
        background-image: url('../images/voitures/background_mercedes_6.jpg');
    ...
    @media screen and (max-width: 450px) {
        ...
        .feature {
            background-image: url('../images/voitures/background_mercedes_5.jpg');
        }
...
<body>
    ...
    <section class="avant-home">
        <div class="container">
            <div class="slides">
                <div class="slide" style="background-image: url('../images/voitures/background_mercedes_1.jpg');
        ...
        background-position: cover;">
                ...
                <div class="slide" style="background-image: url('../images/voitures/background_mercedes_2.jpg');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
                ...
                <div class="slide" style="background-image: url('https://images.hdqwalls.com/wallpapers/mercedes-benz-gle-coupe-uf.jpg');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
                    <div class="slide-content1" style="color: rgba(50,250,250,1)">
                        <h1>Benz GLE Coupe</h1>
                    </div>
                </div>
                <div class="slide" style="background-image: url('../images/voitures/background_mercedes_3.jpg');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
