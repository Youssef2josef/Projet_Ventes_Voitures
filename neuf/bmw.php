...
if (!$connection) { // Contrôler la connexion
    ...
    $audis="SELECT * from voitures where Marque = 'BMW' order by Prix";
...
<head>
    ...
    <title>Bmw</title>
    <link rel="shortcut icon" href="../images/categ/bmw.png" type="image/x-icon">
    ...
    * {
    ...
    .feature {
        padding: 9%;
        background-image: url('../images/voitures/background_bmw_2.jpg');
...
<body>
    ...
    <section class="avant-home">
        <div class="container">
            <div class="slides">
                <div class="slide" style="background-image: url('../images/voitures/background_bmw_1.webp');
        ...
        background-position: cover;">
                ...
                <div class="slide" style="background-image: url('../images/voitures/background_bmw_3.webp');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
                ...
                <div class="slide" style="background-image: url('../images/voitures/background_bmw_4.jpg');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
                    <div class="slide-content" style="color: white;">
                ...
                <div class="slide" style="background-image: url('../images/voitures/background_bmw_6.jpg');
        background-repeat: no-repeat;
        background-size: 100% 100%;
        background-position: cover;">
                    <div class="slide-content" style="color: rgba(80,150,250,1) ; top:30%; font: size 4rem;">
                        <h1>BMW <br>Serie 5</h1>
                    </div>
                </div>
            </div>
