...
<head>
    ...
    <link rel="shortcut icon" href="./images/Icones/message_icon.jpg" type="image/x-icon">
                        ...
                        <table style="width:100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
                            <thead>
                                <tr>
                                    ...
                                    <th style="min-width:200px;">N°Telephone</th>

                                    <th style="min-width:50px;">Contenu</th>
                            ...
                            <tbody>
                                ...
                                if(mysqli_num_rows($exec_requete)>0){
                                    while($row=mysqli_fetch_assoc($exec_requete)){
                                                ...
                                                <td style="text-transform:initial;">'.$row["User_Email"].'</td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown_more">
                                                        <li>
                                                            <a href="./modifierMessage.php?id='.$row["IdM"].'">
                                                                <i class="fa fa-clone"></i>Modifier
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="./supprimerMessage.php?id='.$row["IdM"].'">
...
if($info=="Message supprimé avec succès.") { 
    echo "<script>
                Swal.fire({
                    title: 'Bravo!',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'detailMessage.php';
                    }
                });
              </script>";
}
if($update=="Message edité avec succès.") { 
    echo "<script>
                Swal.fire({
                    title: 'Bravo!',
                    text: 'Message edité avec succès.',
                    icon: 'success',
                    showCancelButton: false,
                    confirmButtonColor: '#3205d1',
                    confirmButtonText: 'OK'
